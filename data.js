...
// Verified against ACF state prevention plans HTML export
// Status values: "approved" | "submitted" | "none"
// Note: DC is listed by ACF as "Submitted, Not Approved" in their map legend,
//       but their hover data lists an approved plan with programs. Shown here
//       as "approved" to reflect the program-level data.

const STATE_DATA = [
  // APPROVED (50 states + DC)
  { name: "Arizona", abbr: "AZ", status: "approved", planYears: "", programs: ["Family Centered Treatment","Intercept","SafeCare","Triple P - Positive Parenting Program - Standard (Level 4)","Healthy Families America","Motivational Interviewing"] },
  ...
  { name: "District of Columbia", abbr: "DC", status: "approved", planYears: "FY 2025-2029", programs: ["Parents as Teachers","Motivational Interviewing"] },
  ...
  { name: "Illinois", abbr: "IL", status: "approved", planYears: "FY 2022-2026", programs: ["Parents as Teachers","Motivational Interviewing","Multisystemic Therapy","Healthy Families America","Trauma-Focused Cognitive Behavioral Therapy","Child-Parent Psychotherapy","Triple P - Positive Parenting Program - Standard (Level 4)"] },
  ...
  { name: "New Jersey", abbr: "NJ", status: "approved", planYears: "FY 2025-2029", programs: ["Motivational Interviewing","Brief Strategic Family Therapy","Intercept","Triple P - Positive Parenting Program - Group (Level 4)","Triple P - Positive Parenting Program - Standard (Level 4)"] },
  ...
  { name: "Ohio", abbr: "OH", status: "approved", planYears: "FY 2022-2026", programs: ["Functional Family Therapy","Parents as Teachers","Motivational Interviewing","Multisystemic Therapy","Healthy Families America","Sobriety Treatment and Recovery Teams (START)","Triple P - Positive Parenting Program - Online (Level 4)"] },
  ...
  { name: "Pennsylvania", abbr: "PA", status: "approved", planYears: "FY 2022-2026", programs: ["Parents as Teachers","Functional Family Therapy","Multisystemic Therapy","Healthy Families America","Homebuilders","Nurse-Family Partnership","Triple P - Positive Parenting Program - Standard (Level 4)","Incredible Years - School Age Basic Program","Incredible Years - Toddler Basic Program"] },
  ...
  { name: "Tennessee", abbr: "TN", status: "approved", planYears: "FY 2022-", programs: ["Multisystemic Therapy","Parent-Child Interaction Therapy","Homebuilders","Nurse-Family Partnership","Brief Strategic Family Therapy","Intercept"] },
  ...
  { name: "Washington", abbr: "WA", status: "approved", planYears: "FY 2025-2029", programs: ["Nurse-Family Partnership","Parents as Teachers","Homebuilders","Functional Family Therapy","Multisystemic Therapy","Parent-Child Interaction Therapy","Motivational Interviewing","Child-Parent Psychotherapy","Promoting First Relationships","SafeCare","Family Spirit","Incredible Years - School Age Basic Program","Incredible Years - Toddler Basic Program","Triple P - Positive Parenting Program - Standard (Level 4)"] },
...
const TERRITORY_DATA = [
  ...
  { name: "Federated States of Micronesia", abbr: "FM", status: "approved", planYears: "", programs: [] },
  ...
  { name: "Republic of Palau", abbr: "PW", status: "approved", planYears: "", programs: [] },
  { name: "Republic of the Marshall Islands", abbr: "MH", status: "approved", planYears: "", programs: [] },
